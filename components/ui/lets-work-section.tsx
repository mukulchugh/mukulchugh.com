...
export function LetsWorkTogether() {
  ...
  return (
    <section id="contact" className="flex min-h-[80vh] items-center justify-center px-6 mb-20 sm:mb-28">
      <div className="relative flex flex-col items-center gap-12">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <h3
              className="text-3xl font-light tracking-tight text-gray-900 dark:text-gray-50 transition-all duration-500 sm:text-4xl"
              style={{
                transform: showSuccess ? "translateY(0)" : "translateY(10px)",
                opacity: showSuccess ? 1 : 0,
          ...
          >
            {/* Left line */}
            <div
              className="h-px w-8 bg-gray-200 dark:bg-gray-700 transition-all duration-500 sm:w-12"
              style={{
            ...
            {/* Button content */}
            <div
              className="relative flex items-center gap-3 overflow-hidden rounded-full border border-gray-200 dark:border-gray-700 px-6 py-3 transition-all duration-500 sm:px-8 sm:py-4"
              style={{
                borderColor: isButtonHovered ? "rgb(17 24 39)" : undefined,
                backgroundColor: isButtonHovered ? "rgb(17 24 39)" : "transparent",
            ...
            >
              <Calendar
                ...
                strokeWidth={1.5}
                style={{
                  color: isButtonHovered ? "rgb(249 250 251)" : "rgb(17 24 39)",
                }}
              />
              <span
        ...
        >
          <div className="flex flex-col items-center gap-6">
            <h2
              className="relative text-center text-5xl font-light tracking-tight text-gray-900 dark:text-gray-50 sm:text-6xl md:text-7xl lg:text-8xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
              style={{
                opacity: isClicked ? 0 : 1,
            ...
            <div className="relative mt-4 flex size-16 items-center justify-center sm:size-20">
              <div
                className="pointer-events-none absolute inset-0 rounded-full border border-gray-200 dark:border-gray-700 transition-all ease-out"
                style={{
                  borderColor: isClicked ? "rgb(17 24 39)" : isHovered ? "rgb(17 24 39)" : undefined,
                  backgroundColor: isClicked ? "transparent" : isHovered ? "rgb(17 24 39)" : "transparent",
              ...
              />
              <ArrowUpRight
                className="size-6 transition-all ease-[cubic-bezier(0.16,1,0.3,1)] sm:size-7 text-gray-900 dark:text-gray-50"
                style={{
                  transform: isClicked
                    ...
                    : isHovered
                      ...
                      : "translate(0, 0)",
                  opacity: isClicked ? 0 : 1,
                  color: isHovered && !isClicked ? "rgb(249 250 251)" : undefined,
        ...
        >
          ...
          <span className="text-xs tracking-widest uppercase text-gray-400 dark:text-gray-500">{siteConfig.email.display}</span>
        </div>
      </div>
    </section>
  )
